const USER_POOL_ID = "ap-southeast-1_qATzXHFqM"
...
$(document).ready(function() {
    ...
    $("#addBtn").click(function(a) {
        ...
        if (0 === newEvent.length) a.target.disabled = !0;
        if (active_events.length > 0) $("#removeBtn").prop("disabled", !1);
        // Retrieve the logged-in email from localStorage

        $.ajax({
            url: "https://8zzv0yxk7l.execute-api.ap-southeast-1.amazonaws.com/Production",
            type: 'POST',
            data: JSON.stringify({body: JSON.stringify(newEvent)}),
